...
public enum CourseDataBaseQueriesUtil {
	...
	GET_COURSE_DETAILS("SELECT a.courseid,a.bannerid,b.rolename FROM courserole as a inner join role as b\\r\\n\"\r\n"
	...
	GET_COURSES_WHERE_USER_IS_STUDENT("SELECT b.* from courserole as a inner join course as \\r\\n\"\r\n"
	...
	GET_COURSES_WHERE_USER_IS_INSTRUCTOR("SELECT b.* from courserole as a inner join course as \\r\\n\"\r\n"
			+ "			+ \"b on a.courseid=b.courseid where a.roleid=3 and a.bannerid=?;"),
	GET_COURSES_WHERE_USER_IS_TA("SELECT b.* from courserole as a inner join course as \\r\\n\"\r\n"
