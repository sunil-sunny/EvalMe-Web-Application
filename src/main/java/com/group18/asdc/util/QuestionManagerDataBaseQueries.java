...
public enum QuestionManagerDataBaseQueries {
	...
	GET_QUESTION_BY_ID(
			"SELECT a.questionid,a.qtitle,a.question,a.datecreated,b.questiontypename FROM questions as a inner join\\r\\n\"\r\n"
	...
	GET_QUESTION_ID("SELECT questionid FROM questions where bannerid=? and questiontypeid=? and qtitle=?\\r\\n\"\r\n"
	...
	GET_ALL_QUESTIONS_SORTEDBY_DATE(
			"SELECT a.questionid,a.qtitle,a.question,a.datecreated,b.questiontypename FROM questions as a \\r\\n\"\r\n"
